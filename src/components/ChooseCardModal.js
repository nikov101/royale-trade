...
class ChooseCardsModal extends React.Component {
  state = {
    ...
    return (
      <div>
        <Modal open onClose={this.goHome} size="large">
          <Modal.Header>
            <FormattedMessage id="myTradeOffer" />
          </Modal.Header>
          <Modal.Content>
            <Container>
              {/* <Row>
              ...
              <ChooseCards
                ...
                header={intl.formatMessage({ id: 'chooseWantCard' })}
                ...
                buttonText={intl.formatMessage({ id: 'next' })}
              ...
              {this.state.step >= 2 ? (
                <ChooseCards
                  ...
                  header={intl.formatMessage({ id: 'chooseOfferCard' })}
                  title={intl.formatMessage({ id: 'selectAll' })}
...
export default injectIntl(ChooseCardsModal);
